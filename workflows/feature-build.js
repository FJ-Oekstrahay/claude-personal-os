...
// Home dirs differ per machine (one username per machine),
 ...
 *
 * CROSS-PROVIDER IS OPT-IN (Geoff, 2026-08-09). This script does not route off Max unless it is
 * invoked with `crossProvider: true`; without it every tier collapses to its Max fallback below and
 * no GLM/Kimi spend happens. Do not flip that default without checking the cross-provider vendor contract first.
 */
