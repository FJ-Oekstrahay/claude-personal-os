...
// CAPPED VERSION — stored at ~/.claude/workflows/deep-research.js
// Agent count math: 1 scope + ~6 search + MAX_FETCH fetch + (MAX_VERIFY_CLAIMS × VOTES_PER_CLAIM) verify + 1 synth
// With defaults below: 1 + 6 + 10 + (10×3) + 1 = ~48 agents (built-in default was 97)
// To adjust: edit MAX_FETCH and MAX_VERIFY_CLAIMS below.

const VOTES_PER_CLAIM = 3
const REFUTATIONS_REQUIRED = 2
const MAX_FETCH = 5           // 5 sources; increase for broader coverage (each +1 = +1 agent)
const MAX_VERIFY_CLAIMS = 5   // 5 claims × 3 votes = 15 verify agents; increase for more depth (each +1 = +3 agents)
