...
## Goal
Before dispatching a researcher agent on multi-part research work, bounce the research questions off a CTO agent in the same thread to sharpen scope and eliminate out-of-scope questions. This cuts wasted research effort by ~30–50% and improves result quality.
