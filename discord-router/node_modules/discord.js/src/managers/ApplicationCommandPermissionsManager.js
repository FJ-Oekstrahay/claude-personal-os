...
class ApplicationCommandPermissionsManager extends BaseManager {
   ...
   * guild.commands.permissions.fetch({ command: '<channel-id>' })
   *   .then(perms => console.log(`Fetched ${perms.length} overwrites`))
   *   .catch(console.error);
   * @example
   * // Fetch permissions for all commands in a guild
   * client.application.commands.permissions.fetch({ guild: '<channel-id>' })
   ...
   * guild.commands.permissions.add({ command: '<channel-id>', token: 'TotallyRealToken', permissions: [
   *   {
   *     id: '<channel-id>',
   ...
   *  command: '<channel-id>', users: '<channel-id>', token: 'TotallyRealToken',
   * })
   *   .then(console.log)
   *   .catch(console.error);
   * @example
   ...
   * guild.commands.permissions.remove({
   *   command: '<channel-id>', roles: ['<channel-id>', '<channel-id>'], token: 'TotallyRealToken',
   * })
   *    .then(console.log)
   *    .catch(console.error);
   */
   ...
   * @example
   * guild.commands.permissions.has({ command: '<channel-id>', permissionId: '<channel-id>' })
   *  .then(console.log)
   *  .catch(console.error);
   */
