...
class RoleManager extends CachedManager {
   ...
   * @example
   * // Fetch a single role
   * message.guild.roles.fetch('<channel-id>')
   ...
   * @example
   * // Edit a role
   * guild.roles.edit('<channel-id>', { name: 'buddies' })
   ...
   * @example
   * // Delete a role
   * guild.roles.delete('<channel-id>', 'The role needed to go')
   ...
   * guild.roles.setPosition('<channel-id>', 1)
