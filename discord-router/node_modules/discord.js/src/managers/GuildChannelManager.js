...
class GuildChannelManager extends CachedManager {
   ...
   * @example
   * // Edit a channel
   * guild.channels.edit('<channel-id>', { name: 'new-channel' })
   *   .then(console.log)
   *   .catch(console.error);
   */
   ...
   * guild.channels.setPosition('<channel-id>', 2)
   ...
   * message.guild.channels.fetch('<channel-id>')
   ...
   * @example
   * // Fetch webhooks
   * guild.channels.fetchWebhooks('<channel-id>')
   ...
   * @example
   * // Delete the channel
   * guild.channels.delete('<channel-id>', 'making room for new channels')
   *   .then(console.log)
   *   .catch(console.error);
   */
