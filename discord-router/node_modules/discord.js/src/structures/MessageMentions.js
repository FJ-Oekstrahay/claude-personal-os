...
class MessageMentions {
  ...
  /**
   * A regular expression that matches user mentions like `<@<channel-id>>`.
  ...
  /**
   * A regular expression that matches role mentions like `<@&<channel-id>>`.
   * The `id` group property is present on the `exec` result of this expression.
   * @type {RegExp}
   * @memberof MessageMentions
   */
  ...
  /**
   * A regular expression that matches channel mentions like `<#<channel-id>>`.
   * The `id` group property is present on the `exec` result of this expression.
   * @type {RegExp}
   * @memberof MessageMentions
   */
