...
class Client extends BaseClient {
   ...
   *   .catch(console.error);
   * @example
   * client.fetchStickerPacks({ packId: '<channel-id>' })
 ...
 *
 * If we have a snowflake '<channel-id>' we can represent it as binary:
 * ```
 * 64                                          22     17     12          0
 *  <channel-id><channel-id>0000  00001  00000  000000000000
