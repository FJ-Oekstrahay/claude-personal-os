...
export interface CDNRoutesDeclarations {
    ...
    /**
     * Route for:
     * - GET `/app-assets/<channel-id>/store/{sticker_pack.banner.asset_id}.{png|jpeg|webp}`
     *
     * This route supports the extensions: PNG, JPEG, WebP
     */
    stickerPackBanner<Format extends StickerPackBannerFormat>(stickerPackBannerAssetId: Snowflake, format: Format): `/app-assets/<channel-id>/store/${string}.${Format}`;
    /**
     * Route for:
