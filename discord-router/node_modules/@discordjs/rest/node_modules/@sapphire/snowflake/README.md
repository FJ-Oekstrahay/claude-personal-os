...
const uniqueId = snowflake.deconstruct('<channel-id>');
```
...
const uniqueId = DiscordSnowflake.deconstruct('<channel-id>');
...
const uniqueId = TwitterSnowflake.deconstruct('<channel-id>');
