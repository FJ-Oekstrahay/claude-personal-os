# Claude Code — the user's Environment

## Who I'm working with
the author (author@example.com). Hardware and firmware background. Fluent code reader — skip the "here's what I did" summaries. Do explain architectural choices, trade-offs, and side effects on the live system.

Communication: casual, direct. Call him the user. No emoji, no fluff.

## Workflow
Default to **plan mode** (Shift+Tab twice) for anything non-trivial. the user prefers understanding the plan before execution.
...
- gog CLI: `/opt/homebrew/bin/gog --account author@example.com`
