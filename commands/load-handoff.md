...
Ask the user to pick a number. If he enters an invalid selection (out of range, non-numeric, or blank), tell him the valid range and ask again.
...
Do not act on the handoff content until the user confirms his selection.

After presenting the handoff summary, fetch recent Discord history for additional context:
- Call fetch_messages with chat_id `1484725914263617666` (the user's Claude Code chat channel), limit 30
