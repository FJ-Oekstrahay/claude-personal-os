...
3. Tell Geoff: "No handoff needed — [one-line summary of what happened]. OK to clear context."
...
Pick a short name for this handoff yourself — derive it from the main topic of the session (e.g. "sales-automation", "infra-cleanup", "discord-router-fix"). Do not ask Geoff for the name.
...
**REQUIRED (Geoff, 2026-07-15): every next step must name its MODEL and its PROMPT FILE.** Geoff does
