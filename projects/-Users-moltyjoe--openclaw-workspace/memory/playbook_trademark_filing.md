...
**Why:** the user wants to reuse this for OverVYou LLC and other marks. Save time by not re-researching the process.

**How to apply:** Any time the user asks to trademark a name or brand.
...
- Strategy: navigate to sign-in, pre-fill email, pause for the user to complete password+MFA, then Playwright takes over
