...
Before telling the user to install or upgrade anything:
...
**Why:** the user has already installed many tools across projects (ngrok, brew packages, etc.). Redundant install suggestions waste time and could cause unintended upgrades.
