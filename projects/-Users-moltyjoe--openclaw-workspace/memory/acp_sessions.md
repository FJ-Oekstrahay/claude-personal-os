...
**Claude Code ↔ the user Discord channel:** `#claudo-main`, channel ID `1484980384860078286`. This is where the user and Claude Code sessions communicate directly — distinct from MoltyJoe's agent channel (1482080556089868451).

**Flow:** the user tells MoltyJoe → MoltyJoe drafts prompt → confirms with the user → spawns ACP session → Claude Code runs in thread.
