...
**Why:** the user uses Discord as his primary interface. Terminal output never reaches him. He has repeated this many times — it's a firm rule, no exceptions.
...
3. Terminal text output is invisible to the user when he's on Discord; do not rely on it
...
- This is non-negotiable — the user has flagged this multiple times as a recurring failure
