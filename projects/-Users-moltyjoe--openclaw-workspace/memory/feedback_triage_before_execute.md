...
description: Before writing code or executing a non-trivial task, ask the user if he wants to triage and delegate to Seymour (and potentially The Architect)
type: feedback
...
- Ask the user one sentence max before triaging, don't over-explain.
