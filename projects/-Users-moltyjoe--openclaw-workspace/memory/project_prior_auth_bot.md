...
description: How to trigger a test call to the prior-auth-bot voice agent; 5053063104 is the user's test line
type: project
---
...
**Why:** When the user says "call 5053063104 test prior auth bot" or similar, run `pa-test-call 5053063104` from any directory. The script handles server + ngrok startup automatically.
