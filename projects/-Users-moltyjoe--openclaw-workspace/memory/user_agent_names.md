...
description: Names the user uses to refer to Claude Code agents — Claudo (me/Sonnet), Seymour (Haiku), The Architect (Opus)
type: user
originSessionId: 3e02b599-6e27-4893-9470-7e504193c1fb
---
the user uses these names for Claude Code agents:
...
When the user says "Claudo" he means me. When he says "ask Seymour" or "have Seymour do it", spin up the seymour subagent. When he says "Cob", spin up the cob subagent. When he says "get The Architect's opinion", invoke The Architect with model:opus.
