...
- Order Detail CSV only shows months where the user has closed orders — Jan/Feb showing empty is normal if no orders booked those months.
...
**Why:** the user wants to periodically pull Xactly data for his Ansys AGI/Synopsys compensation analysis project.
**How to apply:** When the user says "download my xactly dashboard/orders/reports", check if port 9222 is open, confirm auth, then run the appropriate script.
