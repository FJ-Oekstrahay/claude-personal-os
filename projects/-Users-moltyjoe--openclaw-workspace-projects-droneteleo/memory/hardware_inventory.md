...
description: the user's FPV hardware available for Droneteleo testing — FCs, radios, goggles
type: user
...
- **EMAX** (FrSky protocol) — lower priority; the user not focused on FrSky for now
