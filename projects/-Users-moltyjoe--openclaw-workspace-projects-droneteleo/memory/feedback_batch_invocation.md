...
**How to apply:** When the user says "batch this", "use slash batch", or "use your batch skill" — read the protocol from the commands file and apply it directly. No tool call needed. Items must follow the request in the same message.
