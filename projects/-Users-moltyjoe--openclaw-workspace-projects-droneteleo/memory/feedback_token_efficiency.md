...
description: the user wants to continuously look for ways to efficiently use tokens and time — not just when asked
type: feedback
originSessionId: e28427ed-2e7c-4d5d-988c-fe85ca827b43
---
Proactively look for token/time efficiency opportunities throughout every session. Don't wait for the user to ask.
