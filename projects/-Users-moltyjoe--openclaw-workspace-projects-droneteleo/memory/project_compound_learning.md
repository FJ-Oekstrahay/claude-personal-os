...
description: the user wants compound learning built into the droneteleo plan; captured for future session discussion
type: project
originSessionId: 0ffe1c8f-3e75-44df-b82b-e4880308157d
---
the user flagged that when commands fail or behave unexpectedly (e.g. BF 2025.12.2 renamed params, `acc_calibration` triggering rather than reading, port dying on save), those discoveries should be captured as compound learning for:
