...
description: Cloudflare Email Routing config for author@droneteleofpv.com
type: project
originSessionId: 97de6c60-bed0-447e-bc98-5f807a5fe2e5
---
`author@droneteleofpv.com` forwards to `author@example.com` via Cloudflare Email Routing (free tier). Set up 2026-04-10.
