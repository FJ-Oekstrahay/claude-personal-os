...
Always delegate mechanical work to Seymour (Haiku subagent) unilaterally — don't ask the user, just do it.

**Why:** the user's main concern is Sonnet doing mechanical work that Haiku could handle. Mechanical = well-specified file edits, shell commands, CLI execution, reading files for known patterns.
...
- Only present a tier split to the user when Opus is involved
