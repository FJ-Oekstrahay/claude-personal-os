...
description: When hitting a permission wall, log it to the board's Permission Blockers section instead of just asking the user inline
type: feedback
---
...
**Why:** Permission interruptions are frustrating mid-task. the user usually allows the thing anyway — better to collect blockers and fix them in batch than to break flow every time.

**How to apply:** When asking the user for approval on a tool call or permission:
