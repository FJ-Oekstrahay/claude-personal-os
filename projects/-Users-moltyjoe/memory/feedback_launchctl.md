...
**Why:** Other launchctl approaches (`kickstart`, `bootout`) are unreliable for this service. `openclaw gateway restart` is also acceptable but these are the confirmed commands the user uses.
