...
KEYWORD_MAP = {
    ...
    'session handoff':      'commands/session-handoff.md',
    'orchcheck':            'commands/orchcheck.md',
    'orch check':           'commands/orchcheck.md',
    'ork check':            'commands/orchcheck.md',
    'orc check':            'commands/orchcheck.md',
    'orchestra check':      'commands/orchcheck.md',
