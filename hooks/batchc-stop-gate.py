...
def main():
    ...
    # the only outstanding obligation is the review, and a "§12 handoff gate"
    # header over §11 verifier text reads as a contradiction on Discord.
    gate_label = ("§11 — verifier gate" if handoff_written
                  else "§12 — handoff gate")
